##########################################################################################################################
# File automatically-generated by tool: [projectgenerator] version: [2.30.0] date: [Mon Dec 03 19:45:30 CET 2018] 
##########################################################################################################################
...
CC_SOURCES	+= Inc/stmlib/dsp/units.cc
CC_SOURCES	+= Inc/stmlib/utils/random.cc
...
ifdef GCC_PATH
CC = $(GCC_PATH)/$(PREFIX)g++ --specs=nosys.specs -w
AS = $(GCC_PATH)/$(PREFIX)g++ -x assembler-with-cpp
CP = $(GCC_PATH)/$(PREFIX)objcopy
SZ = $(GCC_PATH)/$(PREFIX)size
else
CC = $(PREFIX)g++ --specs=nosys.specs -w
